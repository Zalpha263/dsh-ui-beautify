				...
				return React.createElement('div', {
					...
					children: [
						React.createElement('div', {
							...
							React.createElement('button', { type: 'button', style: PANEL_BTN, onPointerDown: function (e) { e.stopPropagation() }, onClick: function () { dockApi.closePanel(id) } }, React.createElement(CloseIcon, { size: 12 }))
						),
			...
			function DockPanelBody({ showHeader }) {
				...
				if (showHeader) {
					...
					body.push(React.createElement('div', {
						...
						React.createElement('button', { type: 'button', style: PANEL_BTN, onPointerDown: function (e) { e.stopPropagation() }, onClick: function () { closeDock() } }, React.createElement(CloseIcon, { size: 10 }))
					))
				}
				...
				return React.createElement('div', {
					...
					children: [
						React.createElement('div', {
							...
							React.createElement('button', { type: 'button', style: PANEL_BTN, onPointerDown: function (e) { e.stopPropagation() }, onClick: function () { closeDock() } }, React.createElement(CloseIcon, { size: 12 }))
						),
