		...
		function apply(ctx) {
			...
			const SHEET = [
				...
				/* v1.10.3: compact header close — 22x22 borderless icon button (the
				   ...
				   with a smaller icon) */
				'[data-vsc-layout] [data-vsc-hdrx]{display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;padding:0;border:none;background:transparent;border-radius:6px;color:var(--dsw-alias-label-secondary);cursor:pointer;transition:background var(--ds-transition-duration) var(--ds-ease-in-out),color var(--ds-transition-duration) var(--ds-ease-in-out)}',
				'[data-vsc-layout] [data-vsc-hdrx]:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}'
			].join('\n')
